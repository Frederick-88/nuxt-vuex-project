<template>
  <div>
    <h2 class="nuxt__text text-center">HOME</h2>
    <h2 class="mt-3">Here are the things that i explore with Nuxt & Vuex :</h2>
    <!-- Increment -->
    <section>
    ...
    <section class="mt-4">
      ...
      <p class="text-secondary">A little bit messy, but logic was attached good with me hehehhe</p>
